...
bool CProfileManager::CreateProfile(const std::string& Name, ECollisionChannel Channel, bool Enable, ECollisionInteraction Interaction)
{
	...
	for (int i = 0; i < (int)ECollisionChannel::End; ++i)
	{
	...
	ECollisionInteraction Interaction)
{
	...
	Profile->Interaction[(int)Channel] = Interaction;
