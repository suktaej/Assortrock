...
bool CTileMapObj::Init()
{
    ...
    mTileMapRenderer->SetTileTexture("Tile", TEXT("Texture\\tileAtlas.png"));
    ...
    mTileMap->AddTileTextureFrame(64.f, 0.f, 64.f, 64.f);
    mTileMap->AddTileTextureFrame(64.f, 64.f, 64.f, 64.f);
    mTileMap->AddTileTextureFrame(64.f, 128.f, 64.f, 64.f);
    mTileMap->AddTileTextureFrame(128.f, 0.f, 64.f, 64.f);
    mTileMap->AddTileTextureFrame(128.f, 64.f, 64.f, 64.f);
    mTileMap->AddTileTextureFrame(128.f, 128.f, 64.f, 64.f);
    mTileMap->AddTileTextureFrame(192.f, 0.f, 64.f, 64.f);

    SetRootComponent(mTileMapRenderer);

    mTileMap->CreateTile(ETileShape::Rect, 30, 20, FVector2D(64.f, 64.f), -1);
    return true;
}
